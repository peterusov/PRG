/*
BSS-C7: BACK SENSORS SYSTEM (Version 7)
====================================================================
Schematics: BSS-C7 ????????? COM15 - USDN-DWS-10
--------------------------------------------------------------------

RC: BSS-C7 V:15.11.15.0 - initial code;
====================================================================
 */
...
void setup()
{
	...
	//Serial.begin(9600);
	/////
	RFduinoBLE.deviceName = "BSS-C7";
	RFduinoBLE.advertisementData = "bsscdata";
