...
$disk = Get-WmiObject Win32_LogicalDisk -Filter "DeviceID='W:'" | Select-Object Size,FreeSpace
...
$key = "G110DLG2ND8BRF82"

# ThingSpeak URL
$url = "https://api.thingspeak.com/update?key=" + $key + "&field4=" + $disk.FreeSpace
